...
gulp.task "default", ['browser-sync'], ->
  ...
  gulp.watch './content/**/*.md', ['templates', browserSync.reload]
  gulp.watch './content/**/*.yaml', ['templates', browserSync.reload]
  return
...
gulp.task 'compile-watch', (cb) ->
  runSequence ['data', 'content'], 'bundle', cb
  return
# /WATCHIFY
...
gulp.task 'prod', ['prod_clean'], (cb) ->
  runSequence ['static', 'data', 'content'], ['templates', 'compile', 'styles'], cb
